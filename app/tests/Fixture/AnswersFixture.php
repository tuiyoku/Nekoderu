...
class AnswersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cats_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-11-08 12:14:34',
            'modified' => '2016-11-08 12:14:34'
        ],
    ];
}
