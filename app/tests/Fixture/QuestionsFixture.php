...
class QuestionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'displayName' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-11-08 10:41:04',
            'modified' => '2016-11-08 10:41:04'
        ],
    ];
}
